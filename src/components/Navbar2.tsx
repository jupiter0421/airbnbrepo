...
const Navbar2 = () => {
    ...
    return (
        <header className={`fixed top-0 w-full z-50 transition-all duration-300 bg-white border-b ${isScrolled ? "shadow-sm" : ""}`}>
            {/* TOP ROW */}
            <div className="flex items-center justify-between px-5 md:px-10 py-4">
                ...
                <Link to="/" className="flex items-center ">
                    ...
                    >
                        {/* <path fill="currentColor" d={airbnbBrand} /> */}
                ...
                <motion.nav
                    ...
                    className={`hidden md:flex gap-6 text-sm font-medium ${isScrolled ? "pointer-events-none" : "pointer-events-auto"}`}
                >
                    <Link className="hover:text-black flex items-center gap-2" to="/"><img width={24} src="/assets/images/home.png" /> Homes</Link>
                    <Link className="hover:text-black flex items-center gap-2" to="/"><img width={24} src="/assets/images/ballon.png" /> Experiences</Link>
                    <Link className="hover:text-black flex items-center gap-2" to="/"><img width={24} src="/assets/images/service.png" /> Services</Link>
                </motion.nav>

                {/* RIGHT MENU */}
                <div className="flex items-center gap-4 relative">
                    <button className="hidden md:block text-sm font-semibold hover:text-black">Become a host</button>
                    <button className="hover:bg-gray-100 p-2 rounded-full"><Globe size={18} /></button>
                        ...
                        {userMenu && (
                            ...
                            >
                                ...
                                <div className="flex items-start gap-3 px-2 py-2 hover:bg-gray-100 rounded-xl cursor-pointer">
                                    <img src="/assets/images/host.png" className="w-10 h-10 object-contain" />
                                    <div>
                    ...
                    <AnimatePresence>
                        {mobileOpen && (
                            <motion.div
                                ...
                                animate={{ x: 0 }}
                                exit={{ x: "100%" }}
                                className="fixed top-0 right-0 h-full w-72 bg-white shadow-lg z-50 p-5"
                            >
                                ...
                                <nav className="flex flex-col gap-4 text-sm">
                                    <Link to="/" className="hover:underline">Homes</Link>
                                    <Link to="/" className="hover:underline">Experiences</Link>
